      ...
      await sendEmail({
        ...
        body: `
          <div style="max-width:600px">
            ...
            <p>You checked in today at:</p>
            <strong>${attendance.checkIn.toLocaleTimeString()}</strong>
            <p>Please check out within one hour.</p>
            <br/>
            <p>Best Regards,</p>
            <p>EMS</p>
          </div>
    ...
    if (leaveApplication?.status === "PENDING") {
      ...
      await sendEmail({
        ...
        body: `
          <div style="max-width:600px">
            <h2>Hi Admin 👋</h2>
            <p>${employee.firstName} has a pending leave request.</p>
            <p>Department: ${employee.department}</p>
            <p>Leave Date: ${leaveApplication.startDate.toLocaleDateString()}</p>
            <br/>
          ...
          absentEmployees.map((emp) =>
            sendEmail({
              ...
              body: `
                ...
                <p>Please check in as soon as possible.</p>
              `,
            })
          )
        );
