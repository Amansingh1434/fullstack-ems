...
{/* -----form----- */}
         <form onSubmit={handleSubmit} className=' p-6 space-y-5'>
            {/* -----leave type----- */}
            <div>
                <label className=' flex items-center gap-2 text-sm font-medium text-slate-700 mb-2'><FileText className='w-4 h-4'/>Leave type</label>
            ...
            {/* ----duration------ */}
            <div>
              <label className=' flex items-center gap-2 text-sm font-medium text-slate-700 mb-2'><CalendarDays className='w-4 h-4'/>Duration</label>
