  ...
  return (
    ...
    <div className=' flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
      <div className=' w-full max-w-md animate-fade-in'>
        ...
        {error && (
          <div className=' mb-6 p-4 bg-rose-50 border border-rose-700 text-sm rounded-xl flex items-start gap-3'>
        ...
        <form className=' space-y-4' onSubmit={handleSubmit}>
          <div>
            ...
            <input type='email' value={email} onChange={(e)=>setEmail(e.target.value)} required placeholder='amanexample@gmail.com'/>
          </div>
           <div>
            ...
            <button type='buttom' className=' absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors' onClick={()=>setShowPassword(!showPassword)}>
