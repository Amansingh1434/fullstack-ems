...
const Sidebar = () => {
    ...
    const sidebarContent=(
        <>
         ...
         <div className=' p-3 border-t border-white/6'>
            <button onClick={handelLogout} className=' flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150'>
  ...
  return (
    <>
      ...
      {/* Sidebar mobile */}
     <aside
  className={`lg:hidden fixed inset-y-0 left-0 w-72 bg-linear-to-b 
