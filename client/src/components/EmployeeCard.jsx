...
const EmployeeCard = ({employee, onDelete,onEdit}) => {
  ...
  return (
    <div className=' group relative card card-hover overflow-hidden'>
      ...
      {!employee.isDeleted && (
        <div className=' absolute inset-0 bg-linear-to-t from-indigo-700/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center gap-3'>
      ...
      <div className=' p-5'>
     <h2 className=' text-slate-900'>{employee.firstName} {employee.lastName}</h2>
